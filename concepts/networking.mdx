...
See [internal/proxy/ssh_gateway.go:149-188](https://github.com/ThakerKush/hatch/blob/main/internal/proxy/ssh_gateway.go#L149-L188) for implementation.
...
These files are injected by loop-mounting the rootfs **before** Firecracker starts (see [internal/vmm/cloudinit.go:86-145](https://github.com/ThakerKush/hatch/blob/main/internal/vmm/cloudinit.go#L86-L145)).
...
See [internal/vmm/network.go:146-199](https://github.com/ThakerKush/hatch/blob/main/internal/vmm/network.go#L146-L199).
