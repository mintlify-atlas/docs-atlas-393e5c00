...
<Accordion title="View full snapshot code">
  See [internal/vmm/snapshot.go:33-156](https://github.com/ThakerKush/hatch/blob/main/internal/vmm/snapshot.go#L33-L156) for complete implementation.
</Accordion>
...
<Accordion title="View full restore code">
  See [internal/vmm/snapshot.go:161-284](https://github.com/ThakerKush/hatch/blob/main/internal/vmm/snapshot.go#L161-L284) for complete implementation.
</Accordion>
